...
Deltahedraverse is a small, single-developer project. There is no bug
...
- **Or:** open a [GitHub private security advisory](https://github.com/DICTOR-Master/deltahedraverse/security/advisories/new) on this repo.
...
Deltahedraverse has no accounts, no analytics, and (currently) no real
