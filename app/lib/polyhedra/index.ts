 ...
 * files (deltahedra.ts, platonic.ts, and eventually archimedean.ts,
 * johnson.ts) stay independently importable for family-specific logic (the
...
export const POLYHEDRON_IDS: string[] = [...DELTAHEDRON_IDS, ...PLATONIC_ADDITION_IDS];
