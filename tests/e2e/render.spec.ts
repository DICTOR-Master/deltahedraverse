...
test('renders the canvas and every shape across all 6 wheel families (8 deltahedra + 2 Platonic + 13 Archimedean + 78 Johnson + 2 Catalan + 14 prisms/antiprisms)', async ({ page }) => {
